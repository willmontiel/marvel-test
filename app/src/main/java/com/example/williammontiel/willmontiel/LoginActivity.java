...
import com.example.williammontiel.willmontiel.db.UserDbHelper;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin(boolean register) {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, register);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean createUser() {
            ...
            Long res = userDbHelper.saveUser(user);

            if (res == -1) {
                mMessage = getResources().getString(R.string.error_server);
                return false;
            }
        ...
        protected Boolean loginUser() {
            ...
            user = userDbHelper.validateLogin(mEmail, mPassword);
            if (user != null) {
                return true;
            }

            mMessage = getResources().getString(R.string.error_incorrect_password);
            return false;
        }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                if (mRegister) {
                    ...
                    mPasswordView.setError(getResources().getString(R.string.register_success));
